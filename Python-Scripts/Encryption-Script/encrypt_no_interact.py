...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Encrypt all files in a specified folder using AES encryption.")
    parser.add_argument("-l", "--location", type=str, required=True, help="Folder location to encrypt")
    ...
    folder_to_encrypt = args.location
    code_word = args.password
